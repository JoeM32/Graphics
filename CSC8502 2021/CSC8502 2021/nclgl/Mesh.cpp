...
void	Mesh::BufferData()	{
	...
	//auto ptr = glMapBuffer(bufferObject[COLOUR_BUFFER], GL_WRITE_ONLY);
...
Mesh* Mesh::GenerateTriangle() {
	...
	float size = 1.0f;
	m->textureCoords[0] = Vector2(0.5f/size, 0.0f / size);
	m->textureCoords[1] = Vector2(1.0f / size, 1.0f / size);
	m->textureCoords[2] = Vector2(0.0f / size, 1.0f / size);
